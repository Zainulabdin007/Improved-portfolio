...
export default function HeroAuroraContent() {
  return (
    <div className="hero-aurora">
      <p className="hero-aurora__greeting">Hi, I'm</p>

      <GlitchText speed={1.1} enableShadows className="hero-aurora__name">
        Zain Bughio
      </GlitchText>

      <p className="hero-aurora__location">
        <span aria-hidden="true" className="hero-aurora__pin">
          📍
        </span>
        Waterloo, UWaterloo Math
      </p>

      <p className="hero-aurora__bio">
        Math @ UWaterloo. I turn <em>data</em>, <em>code</em>, and curiosity into
        things people actually want to use.
      </p>

      <ul className="hero-aurora__socials">
        {SOCIALS.map(({ id, label, href, path }) => (
          <li key={id}>
            <a
              className="hero-aurora__social-link"
              href={href}
              target="_blank"
      ...
      <a
        className="hero-aurora__resume"
        href="/Zain_Bughio-resume.pdf"
        target="_blank"
        rel="noopener noreferrer"
      >
        Resume
