...
export default function ContactPanel() {
  return (
    <div className="contact-shell" {...salFadeAttrs(80, 850, { repeat: true })}>
      <h2 className="contact-shell__title">Get in Touch</h2>
      <p className="contact-shell__message">
        Feel free to reach out anytime — whether it&apos;s a question, an opportunity,
        or just a hello. I&apos;m always open to collaborating on projects, hackathons,
      ...
      <p className="contact-shell__rights">Zain Bughio. All rights reserved.</p>
    </div>
  )
}
